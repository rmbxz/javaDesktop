...
public class Thread05 {
	...
	Runnable runnable06 = new Thread06(); // job,stack
	Thread thread06 = new Thread(runnable06,"thread06");// worker
	    
	// this is the join, stop(waiting) thread07, then run and finish thread06
	Runnable runnable07 = new Thread07(thread06); // job,stack
	Thread thread07 = new Thread(runnable07,"thread07"); // worker
